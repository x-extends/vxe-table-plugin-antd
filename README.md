...
基于 [vxe-table](https://www.npmjs.com/package/vxe-table) 表格的适配插件，用于兼容 [ant-design-vue](https://www.npmjs.com/package/ant-design-vue) 组件库
...
```shell
npm install vxe-table@legacy vxe-table-plugin-antd@legacy ant-design-vue@1
```
